...
public class CommentController {
    ...
    public Result<List<List<CommentVO>> getCommentsByPageId(@PathVariable Long pageId) {
        List List<CommentVO> comments = commentService.getCommentsByPageId(pageId);
    ...
    public Result Result<CommentVO> createComment(
    ...
    public Result Result<CommentVO> replyComment(
    ...
    public Result Result<CommentVO> updateComment(
