...
public class PageController {
    ...
    public Result<List<List<PageTreeVO>> getPageTree(@PathVariable Long wikiId) {
        List List<PageTreeVO> pages = pageService.getPageTree(wikiId);
    ...
    public Result Result<PageVO> createPage(
     ...
     */
    @GetMapping("/pages/{id}")
    public Result Result<PageVO> getPage(@PathVariable Long id) {
     ...
     */
    @PutMapping("/pages/{id}")
    public Result Result<PageVO> updatePage(
    ...
    public Result<List<List<PageVersionVO>> getPageVersions(
            @PathVariable Long id,
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "20") int pageSize) {
        Pageable pageable = PageRequest.of(page - 1, pageSize, Sort.by("version").descending());
        List List<PageVersionVO> versions = pageService.getPageVersions(id, pageable);
    ...
    public Result Result<PageVO> restoreVersion(
            @PathVariable Long id,
