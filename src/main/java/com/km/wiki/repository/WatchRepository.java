 ...
 */
@Repository
public interface WatchRepository extends JpaRepositoryRepository<Watch, Long> {
     ...
     * @return 关注记录Optional
     */
    Optional Optional<Watch> findByUserIdAndPageId(Long userId, Long pageId);
     ...
     * @return 关注分页列表
     */
    Page Page<Watch> findByUserIdOrderByCreatedAtDesc(Long userId, Pageable pageable);
     ...
     * @return 关注列表
     */
    List List<Watch> findByPageId(Long pageId);
