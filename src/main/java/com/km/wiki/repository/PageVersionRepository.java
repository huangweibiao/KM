 ...
 */
@Repository
public interface PageVersionRepository extends JpaRepositoryRepository<PageVersion, Long> {
     ...
     * @return 版本列表
     */
    List List<PageVersion> findByPageIdOrderByVersionDesc(Long pageId, Pageable pageable);
     ...
     * @return 版本列表
     */
    List List<PageVersion> findByPageIdOrderByVersionDesc(Long pageId);
     ...
     * @return 版本对象
     */
    Optional Optional<PageVersion> findByPageIdAndVersion(Long pageId, Integer version);
