 ...
 */
@Repository
public interface NotificationRepository extends JpaRepositoryRepository<Notification, Long> {
     ...
     * @return 通知分页列表
     */
    Page Page<Notification> findByUserIdOrderByCreatedAtDesc(Long userId, Pageable pageable);
     ...
     * @return 通知分页列表
     */
    Page Page<Notification> findByUserIdAndIsReadOrderByCreatedAtDesc(
     ...
     * @return 未读通知列表
     */
    List List<Notification> findByUserIdAndIsReadOrderByCreatedAtDesc(Long userId, Integer isRead);
     ...
     * @return 通知分页列表
     */
    Page Page<Notification> findByUserIdAndTypeOrderByCreatedAtDesc(
